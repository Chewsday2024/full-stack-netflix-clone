    ...
    <div className="bg-black min-h-screen text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-center gap-3 mb-4">
          <button
            className={`py-2 px-4 rounded cursor-pointer ${activeTab === 'movie' ? 'bg-red-700' : 'bg-gray-800'} hover:bg-red-700`}
          ...
          <button
            className={`py-2 px-4 rounded cursor-pointer ${activeTab === 'tv' ? 'bg-red-700' : 'bg-gray-800'} hover:bg-red-700`}
          ...
          <button
            className={`py-2 px-4 rounded cursor-pointer ${activeTab === 'person' ? 'bg-red-700' : 'bg-gray-800'} hover:bg-red-700`}
