      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 relative">
            <img src="/tv.png" alt="Tv image" className="mt-4 relative z-2" />

            <video
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 z-1"
              playsInline
              autoPlay={true}
              muted
              loop
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 relative overflow-hidden">
            <img src="/device-pile.png" alt="Device image" className="mt-4 relative z-2" />

            <video
              className="absolute top-2 left-1/2 -translate-x-1/2 h-4/6 z-1 max-w-[63%]"
              playsInline
              autoPlay={true}
              muted
              loop
